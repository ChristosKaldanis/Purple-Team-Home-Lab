...
SECTION Α — Reset Wazuh SERVER (Ubuntu VM <server_ip>)
Step 1 — Uninstall
...
Και στο browser: https://<server_ip>

Section Β — Reset Wazuh AGENT (Ubuntu Agent <target_ip>)
Step 1 — Uninstall
...
sudo WAZUH_MANAGER='<server_ip>' dpkg -i wazuh-agent_4.7.0-1_amd64.deb
